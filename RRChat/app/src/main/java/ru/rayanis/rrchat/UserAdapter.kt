...
import ru.rayanis.rrchat.databinding.UserListItemBinding

class UserAdapter: ListAdapter<User, UserAdapter.ItemHolder>(ItemComparator()) {

    class ItemHolder(private val b: UserListItemBinding): RecyclerView.ViewHolder(b.root) {
        fun bind(user: User) = with(b) {
